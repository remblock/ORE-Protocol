...
then
  ...
  ssh -i ~/.ssh/id_rsa -p $ssh_port $remote_user "cd $remote_server_folder; echo "$file_name.snaponly.tar.gz" > latestsnapshot.txt"
...
#****************************************************************************************************#
  ...
  ssh -i ~/.ssh/id_rsa -p $ssh_port $remote_user "cd $remote_server_folder; echo "$file_name-blockslog.tar.gz" > latestblocks.txt"
...
#****************************************************************************************************#
  ...
  ssh -i ~/.ssh/id_rsa -p $ssh_port $remote_user "cd $remote_server_folder; echo "$file_name-state_history.tar.gz" > lateststatehistory.txt"
